...
$src:=$in.platformPath
$dst:=$out.platformPath

C_PICTURE:C286($PDF)

$params:=New object:C1471

READ PICTURE FILE:C678($src;$PDF)
$params.in:=$PDF
...
/*
a stamp is a fixed size image annotation on safari, resizable on adobe reader
jpg, png supported
*/
...
If (True:C214)
	$params.pages[0].annotation[3].path:=$iconFile
Else 
	$params.pages[0].annotation[3].path:=$icon
End if 

$params.pages[0].annotation[3].x:=90
...
WRITE PICTURE FILE:C680($dst;$PDF)
